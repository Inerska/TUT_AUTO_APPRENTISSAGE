			...
			<section className="text-gray-600 body-font">
				<div className="container px-5 py-24 mx-auto">
					<div className="flex flex-col text-center w-full mb-20">
						<h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Statistiques</h1>
						{/* <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Statistiques générales .</p> */}
					</div>
					<div className="flex flex-wrap -m-4 text-center">
						<div className="p-4 md:w-1/4 sm:w-1/2 w-full">
							<div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed">Exercices créé</p>
							</div>
						</div>
						<div className="p-4 md:w-1/4 sm:w-1/2 w-full">
							<div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
						...
						<div className="p-4 md:w-1/4 sm:w-1/2 w-full">
							<div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed">Exercices démarré</p>
							</div>
						</div>
						<div className="p-4 md:w-1/4 sm:w-1/2 w-full">
							<div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
								...
								<p className="leading-relaxed">Exercices terminé</p>
							</div>
						</div>
					</div>
				</div>
