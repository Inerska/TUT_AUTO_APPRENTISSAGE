...
export default function MenuModifyExercise() {
	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		//TODO : modifier l'exercice dans la base de données
	};
	...
	return (
		<div className="bg-lite-quinary text-black flex overflow-y-hidden overflow-x-hidden">
			...
			<main className="w-full m-8 bg-white rounded-xl p-8">
				<h1 className="text-3xl font-bold mb-4">Modifier un exercice</h1>
